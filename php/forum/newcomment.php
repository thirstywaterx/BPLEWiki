...
try {
    ...
    if(!(isset($_POST["content"]) and isset($_POST["tocomment"]) and isset($_POST["topic"]))){
    ...
    $sql="INSERT INTO topiccomment (user, content, topic, tocomment)
    VALUES (?, ?, ?, ?)";
    ...
    $bp_fileid=(int)ioput::test_input($_POST["topic"]);
    if(!$stmt->execute()){
